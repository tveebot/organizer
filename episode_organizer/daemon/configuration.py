...
class Configuration:
    ...
    def from_dict(config: dict):
        ...
        KeyError will be raised. If the dictionary does not define some configuration parameter, then the default 
        value is used.
    ...
    def load(self, config_file):
        """
        Loads the configuration file into memory. If the file does not exist, then it is ignored and the default values 
        are kept.  
