...
class Mapper:
    """
    Mapper is one of the central components. Its job is to take a string and obtain the episode
    information from that string. This string can't be any string is expected have a format
    similar to 'TV.Show.Name.S01E02.720p', where the substring 'TV.Show.Name' indicates the name
    of the episode's tv show and 'S01E02' indicates that the episode is the second of season 1.
    This string is provided by the organizer.
    """
    ...
    def map_to_episode(self, name: str) -> Episode:
        """
        Maps a name to an episode object. The input name maybe the name of a folder or a file.
        The name is expected have a format similar to 'TV.Show.Name.S01E02.720p', where the
        substring 'TV.Show.Name' indicates the name of the episode's tv show and 'S01E02'
        indicates that the episode is the second of season 1. Characters to the right of 'S01E01'
        are all ignored.
